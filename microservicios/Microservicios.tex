...
\usepackage{caption}
\usepackage{etoolbox}
\newcommand{\icon}[1]{\includegraphics[height=20pt]{#1}}
\robustify{\icon}
\makeindex
\graphicspath{{./img/}}
...
\section{Arquitectura orientada a servicios}\index{Arquitectura orientada a servicios}
...
\subsection{Microservicios}\index{Microservicios}
...
Algunas características destacadas sobre Docker en la conferencia son las siguientes: es portable, ligero, automatizable, autocontenido, aislado(ofrece entorno de desarrollo aislado que se comporta a modo de sandbox), agiliza el despliegue y el mantenimiento.
...
\bibitem{zdwt}Zero Downtime, CloudPatterns.org. \href{http://cloudpatterns.org/design_patterns/zero_downtime}{Enlace}
\end{thebibliography}
