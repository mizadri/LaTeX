...
\textsc{\Large Universidad Complutense de Madrid}\\[0.5cm] % Major heading such as course name
...
\begin{figure}[h]
        ...
        \includegraphics[width=3cm,keepaspectratio]{cc-by-sa.png}
        \label{fig:by-sa}
        \caption{ This work is licensed under a {\color{blue}\href{https://creativecommons.org/licenses/by/4.0/legalcode}{CC-BY-SA 4.0 License}}.}
...
\subsection{Sections}\index{Section}
