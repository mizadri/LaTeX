...
\cventry{2017--actualidad}{Doctorando en Ingeniería Informática (cum laude)}{UCM}{Madrid}{\textit{Sobresaliente cum laude}}{}
...
\cventry{Oct. 2017- Diciembre 2021.}{Contrato predoctoral UCM de personal investigador en formación.}{DACYA}{Madrid}{}{Investigación sobre planificación de tareas y particionado de cache, trabajando tanto en C a bajo nivel, como en python para el análisis de resultados (extracción de métricas y conclusiones con jupyter/pandas/matplotlib).}

\cventry{Contrato predoctoral UCM de personal investigador en formación.}
