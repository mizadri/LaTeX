...
\medskip
\item \textbf{Embedded systems.} Double authentication system with RFID and password using 2 Arduino Uno boards and a Raspberry Pi 2 ({\color{blue}\href{https://github.com/mizadri/big-data}{repository}}). 
\medskip
